...
# Try to import yt_dlp, log error if missing
try:
    import yt_dlp
...
class MusicPlayer:
    ...
    async def play_next(self):
        ...
        try:
            ...
            # Re-fetch URL to prevent expiration (Tier 3.10)
            ...
            def after_playing(error):
                ...
                # Thread-safe playback continuation
    ...
    async def add_to_queue(self, query: str) -> dict:
        ...
        try:
            ...
            # Start playing if idle (Tier 1.3 fix)
    ...
    def skip(self):
        if self.voice_client and self.voice_client.is_connected():
            if self.voice_client.is_playing() or self.voice_client.is_paused():
                self.voice_client.stop() # Triggers the 'after' callback, which calls play_next()
                return True
        return False
